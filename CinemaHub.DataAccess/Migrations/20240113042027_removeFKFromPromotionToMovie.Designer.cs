...
namespace CinemaHub.DataAccess.Migrations
{
    ...
    [Migration("20240113042027_removeFKFromPromotionToMovie")]
    partial class removeFKFromPromotionToMovie
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CinemaHub.Models.Showtime", b =>
                {
                    b.HasOne("CinemaHub.Models.Movie", "Movie")
                        .WithOne("Showtime")
                        .HasForeignKey("CinemaHub.Models.Showtime", "MovieID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CinemaHub.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("CinemaHub.Models.Seat", "Seat")
                        .WithOne("Ticket")
                        .HasForeignKey("CinemaHub.Models.Ticket", "SeatID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("CinemaHub.Models.Voucher", "Voucher")
                        .WithOne("Ticket")
                        .HasForeignKey("CinemaHub.Models.Ticket", "VoucherID");
